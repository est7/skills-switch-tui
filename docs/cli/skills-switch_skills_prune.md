## skills-switch skills prune

Remove projections whose Skill left its source

```
skills-switch skills prune [flags]
```
...
```
  -h, --help           help for prune
      ...
      --yes            remove the orphaned projections (default: list only)
```
